...
int      UB = BIG_INT;                     // upper bound on the number of stations needed
...
void usage (char *prog)
{
   ...
   fprintf (stderr, "    -t: CPU time limit\n");
	fprintf (stderr, "    -u: Optional initial upper bound\n");
...
void testprob()
{
   int      count, graph, i, iter, j, n_stations, *stations, sum, t_sum, upper_bound;
